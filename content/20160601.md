...
# 壓力角
pa = 20
gear50 = Spur(ctx).Gear(x, y, r, n , pa, "black")
...
ctx.fillText("40423131",(canvas.width)/2-60,(canvas.height)/2-25)
ctx.stroke()
</script>

由最右邊齒數 16 齒開始囓合, 依序增加 2 齒, 當排至平面四齒囓合後, 第五位組員則以垂直方向向下囓合兩個齒輪後, 轉由右至左水平排列
